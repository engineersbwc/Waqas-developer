...
export const ImageSlider: React.FC = () => {
  ...
  return (
    <div className="relative w-full aspect-[16/10] md:aspect-[16/8] overflow-hidden rounded-2xl bg-[#0a0a0a] border border-white/10 shadow-2xl">
      ...
      <div className="absolute top-6 left-6 z-20 bg-black/60 backdrop-blur-xl px-4 py-2 rounded-full border border-white/10 flex items-center space-x-2">
        <span className="w-2 h-2 rounded-full bg-[#f5ba41] animate-pulse"></span>
